...
<body>
	<div class="banner">
		...
		<div class="col-xs-5 input-group" style="position:absolute; background-color:purple; clear:both">
			<input type="text" id="searchbar" class="col-s-3 searchbar" placeholer="Search">
			<span class="input-group-btn"><button id="searchbarbutton" class="btn btn-secondary" type="button"><span class="glyphicon glyphicon-search"></button></span></span>
	</div>
